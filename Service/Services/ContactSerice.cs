...
{
    public class ContactSerice : IContactService
    {
        private IRepository<Contact> _repository;

        public ContactSerice(IRepository<Contact> repository)
        {
        ...
        public bool SendMail(string from, string message)
        {
            try
            {
                ...
                client.Credentials = new NetworkCredential("datacode2020@gmail.com", "SalamSagol98*#");
